...
{
    // START: UpdateUserHandler1327954211
    public class UpdateUserHandler1327954211 : Wolverine.Runtime.Handlers.MessageHandler
    {
        private readonly Lamar.IContainer _rootContainer;

        public UpdateUserHandler1327954211(Lamar.IContainer rootContainer)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            * A formal factory provider may be an alternative
            */
            var updateUserHandler = nestedContainer.GetInstance<test01.Application.Users.Handlers.UpdateUserHandler>();
            // The actual message body
            var updateUser = (test01.Internal.Contract.Users.Core.Commands.UpdateUser)context.Envelope.Message;

            
            // The actual message execution
            var outgoing1 = await updateUserHandler.HandleAsync(updateUser, cancellation).ConfigureAwait(false);
    ...
    // END: UpdateUserHandler1327954211
